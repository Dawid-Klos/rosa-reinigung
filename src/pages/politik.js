...
const Politik = () => {
  return (
    <main className="policy">
      <img className="policy__logo" src={Logo} alt="Rosa Reinigung Firmenlogo" />
      ...
      <div>
        <div>
          <div>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Rosa Reinigung, Herbert-Weichmann-Str.
                  28, 22085 Hamubrg, Germany.
                </p>
              </li>
              <li>
                <p>
            ...
            <h2>5. Transfer of Your Personal Data</h2>
            <p>
            ...
            <h2>6. Delete Your Personal Data</h2>
            <p>
            ...
            <p>
              Our Service uses third-party services for booking system that may collect information used to identify
              You. We do not share the information and they are stored securely. The stored information are only used
              for the purpose of booking and bussiness related actions such us contacting customers with information
              about their booking or other information.
            </p>
            <p>
              The email service provider is called <strong>EmailJS</strong> and by using Our Service you agree to their
              Privacy Policy as well. You can find the Data Processing Agreements at{" "}
              <a href="https://www.emailjs.com/legal/data-protection-agreement/">EmailJS Privacy Policy</a>.
            </p>
            ...
            <ul>
              ...
              <li>
                <p>
                  By visiting this page on our website: <Link to="/politik/">Politik website</Link>.
                </p>
              </li>
            </ul>
          </div>
